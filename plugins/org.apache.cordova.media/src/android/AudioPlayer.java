...
//    private static int MEDIA_ERR_NONE_SUPPORTED = 4;
    ...
    public void setGain(float volume) {
        //AudioManager audiMgr = (AudioManager) Context.getSystemService(Context.AUDIO_SERVICE);
             //   int sm2value = (int)Math.ceil(volume * audiMgr.getStreamMaxVolume(AudioManager.STREAM_MUSIC));
               // if (sm2value != 0) {
              //  audiMgr.setStreamVolume(AudioManager.STREAM_MUSIC, sm2value, AudioManager.FLAG_PLAY_SOUND);
              //audiMgr.setMicrophoneMute(false);
               // } else {
                  //  System.out.println("AudioHandler.setGain() Error: level is " + volume);
               // }
        //this.player.setVolume(volume, volume);
    }
    /**
