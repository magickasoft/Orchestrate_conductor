...
- (void)setGain:(CDVInvokedUrlCommand*)command
{
  NSString* callbackId = command.callbackId;

  #pragma unused(callbackId)

  NSNumber* gain = [command.arguments objectAtIndex:0 withDefault:[NSNumber numberWithFloat:1.0]];
  AVAudioSession *audioSession = self.avSession;
